    ...
    <xsl:template match="/">
        <html>
            ...
            <body class="winnerprovider-notification">
                ...
                <table align="center">
                    <tr>
                         <th> N°Transacci&oacute;n </th><th> Nombre Cliente </th><th> N°Tarjeta </th><th> Precio Cancelado </th>

                    <xsl:for-each select="userInfo">
                        <tr align="center">
                            <td class="column"><xsl:value-of select="number_sell"/></td>
                            <td class="column"><xsl:value-of select="user_name"/></td>
                            <td class="column"><xsl:value-of select="number_card"/></td>
                            <td class="column"><xsl:value-of select="shipping_address"/></td>
                            <td class="column"><xsl:value-of select="price_canceled"/> </td>
                        </tr>
                    </xsl:for-each>
                </table>
